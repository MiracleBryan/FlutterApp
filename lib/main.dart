...
class MyAppState extends ChangeNotifier {
  ...
  void deleteFavorite(certainFavorite){
    if(favorites.contains(certainFavorite)){
      favorites.remove(certainFavorite);
    }
